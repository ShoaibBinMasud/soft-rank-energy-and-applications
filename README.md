...
- pandas=0.23.4
## How to run the code
'Kncokff_generator' folder contains all the functions to generate knockoffs. In order to run the code effectively, download these functions and move them to the 'Examples'.
## Examples
